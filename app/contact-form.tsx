...
export default function ContactForm() {
   ...
   return (
      <form action={formSubmit}>
         ...
         <button type="submit" className="text-black bg-emerald-400 hover:bg-emerald-600 focus:ring-2 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg w-full sm:w-auto px-5 py-2.5 text-center">Submit</button>
      </form>
   )
}